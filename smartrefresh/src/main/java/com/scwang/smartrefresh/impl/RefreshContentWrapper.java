package com.scwang.smartrefresh.impl;
...
import com.scwang.smartrefresh.util.ScrollBoundaryUtil;
...
public class RefreshContentWrapper implements RefreshContent {
    ...
    private com.scwang.smartrefresh.impl.RefreshScrollBoundaryAdapter mBoundaryAdapter = new com.scwang.smartrefresh.impl.RefreshScrollBoundaryAdapter();
...
//        mContentView.measure(widthSpec, heightSpec);
    ...
    public void setRefreshScrollBoundary(RefreshScrollBoundary boundary) {
        if (boundary instanceof com.scwang.smartrefresh.impl.RefreshScrollBoundaryAdapter) {
            mBoundaryAdapter = ((com.scwang.smartrefresh.impl.RefreshScrollBoundaryAdapter) boundary);
        } else {
