package com.scwang.smartrefresh.api;

import android.support.annotation.NonNull;
import android.view.View;

import com.scwang.smartrefresh.constant.SpinnerStyle;
import com.scwang.smartrefresh.listener.OnStateChangedListener;
...
public interface RefreshInternal extends OnStateChangedListener {
     ...
     * @param extendHeight extendHeaderHeight or extendFooterHeight
     */
    void onStartAnimator(com.scwang.smartrefresh.api.RefreshLayout layout, int height, int extendHeight);
     ...
     */
    int onFinish(com.scwang.smartrefresh.api.RefreshLayout layout, boolean success);
