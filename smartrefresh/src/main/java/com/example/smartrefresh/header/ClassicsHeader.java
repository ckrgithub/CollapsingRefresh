package com.example.smartrefresh.header;
...
import com.example.smartrefresh.R;
...
import com.example.smartrefresh.internal.PathsDrawable;
import com.example.smartrefresh.internal.ProgressDrawable;
...
public class ClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    public void onStateChanged(RefreshLayout refreshLayout, RefreshState oldState, RefreshState newState) {
        if (refreshStateListener != null) {
            refreshStateListener.onRefreshStateChanged(oldState, newState);
        }
        switch (newState) {
            case None:
...
//    }
    ...
    //</editor-fold>
    OnRefreshStateListener refreshStateListener;
    ...
    public interface OnRefreshStateListener {
        void onRefreshStateChanged(RefreshState oldState, RefreshState newState);
    }
}
