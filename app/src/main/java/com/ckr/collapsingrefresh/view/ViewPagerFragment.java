...
import com.ckr.collapsingrefresh.widget.MyFragmentPagerAdpater;
...
public class ViewPagerFragment extends BaseFragment implements AppBarLayout.OnOffsetChangedListener, ViewPager.OnPageChangeListener {
    ...
    private void initTabLayout() {
        ...
        viewPager.setAdapter(new MyFragmentPagerAdpater(getChildFragmentManager(), fragmentList, tabTitles));
